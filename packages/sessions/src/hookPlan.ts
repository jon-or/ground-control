...
function refuse(reason: string, remedy: string): HookPlan {
 ...
 */
export function planHookInstall({ settingsText, home, wanted }: HookPlanInput): HookPlan {
