import { dirKey, join } from './paths.js';
...
/**
 * One VS Code window, as it announces itself in the lock file the Claude Code extension writes per window. The only
 * live enumeration of windows on the machine — VS Code offers none — and undocumented, so **version-fragile** (§22).
 */
