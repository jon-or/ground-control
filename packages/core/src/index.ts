...
export { branchOf, compilePattern, findCheckout, issueNumberFrom, linkOf } from './link.js';
export { repositoryAt, repositoryKey, repositoryOf } from './repository.js';
export { clonesOf, worktreeFor, worktreeIndex, worktreesOf } from './worktrees.js';
export type { CardWorktree, Clone, ScannedWorktree, WorktreeIndex } from './worktrees.js';
export { commonDirOf, gitDirOf } from './gitDir.js';
...
export type { CheckoutReaders, ListDir, MachineDeps, MachineReaders, ReadTail, ReadText, StatMtime } from './machine.js';
export type {
  ActivityChange,
  ActivityPlan,
  ActivityPlanInput,
