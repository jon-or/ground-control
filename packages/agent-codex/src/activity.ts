...
/**
 * Codex's phase signal: a hook script writing one marker per session (`docs/mechanics.md` §40). It carries the
 * roster too, which Claude's does not — Codex has no command that lists its live sessions (§39).
 *
