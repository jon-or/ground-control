...
| --- | --- | --- |
| **Agent adapter** | Which sessions are alive, what each is doing, what each is called, and — optionally — one bounded question answered as JSON | `claude` |
